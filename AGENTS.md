...
This file is the quick-reference operating contract for futures-kotlin. The longer
...
futures-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`futures`](https://crates.io/crates/futures). Upstream Rust is the behavioral oracle while the
