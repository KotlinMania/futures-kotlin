...
kotlin {
    ...
    swiftExport {
        moduleName = "Futures"
        flattenPackage = "io.github.kotlinmania.futures"
    }

    android {
        namespace = "io.github.kotlinmania.futures"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "futures-kotlin", version.toString())

    pom {
        name.set("futures-kotlin")
        description.set("Kotlin Multiplatform port of rust-lang/futures-rs - An implementation of futures and streams featuring zero allocations, composability, and iterator-like interfaces")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/futures-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/futures-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/futures-kotlin.git")
...
dependencies {
    ...
    add(codeqlJvmCompileClasspath.name, "org.jetbrains.kotlinx:kotlinx-collections-immutable:0.5.0")
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleFuturesXCFramework",
    "assembleFuturesDebugXCFramework",
    "assembleFuturesReleaseXCFramework",
    "assembleDebugIosFatFrameworkForFuturesXCFramework",
    "assembleReleaseIosFatFrameworkForFuturesXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForFuturesXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForFuturesXCFramework",
    "assembleDebugMacosFatFrameworkForFuturesXCFramework",
    "assembleReleaseMacosFatFrameworkForFuturesXCFramework",
    "assembleDebugTvosFatFrameworkForFuturesXCFramework",
    "assembleReleaseTvosFatFrameworkForFuturesXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForFuturesXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForFuturesXCFramework",
    "assembleDebugWatchosFatFrameworkForFuturesXCFramework",
    "assembleReleaseWatchosFatFrameworkForFuturesXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForFuturesXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForFuturesXCFramework",
